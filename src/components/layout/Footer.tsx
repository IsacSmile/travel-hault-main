...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#F5F0E6] text-[#051b2e] border-t border-gray-200 font-sans pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
              ...
              {subscribed ? (
                ...
                <form onSubmit={handleSubscribe} className="flex gap-2 max-w-sm">
                  <input
                    ...
                    className="flex-1 px-4 py-2.5 bg-white border border-gray-300 rounded-xl text-xs text-[#051b2e] placeholder-gray-400 outline-none focus:border-[#b8934b] shadow-sm"
                  />
                  <button
                    type="submit"
                    disabled={loading}
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a href="https://instagram.com" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-white hover:bg-[#051b2e] text-[#051b2e] hover:text-[#c9a15a] border border-gray-300 flex items-center justify-center transition shadow-sm" title="Instagram">
              ...
              <a href="https://facebook.com" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-white hover:bg-[#051b2e] text-[#051b2e] hover:text-[#c9a15a] border border-gray-300 flex items-center justify-center transition shadow-sm" title="Facebook">
              ...
              <a href="https://twitter.com" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-white hover:bg-[#051b2e] text-[#051b2e] hover:text-[#c9a15a] border border-gray-300 flex items-center justify-center transition shadow-sm" title="Twitter">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/></svg>
              </a>
              <a href="https://youtube.com" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-white hover:bg-[#051b2e] text-[#051b2e] hover:text-[#c9a15a] border border-gray-300 flex items-center justify-center transition shadow-sm" title="YouTube">
