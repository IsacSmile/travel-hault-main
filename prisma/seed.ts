...
async function main() {
  ...
  const passwordHash = await bcrypt.hash('sahajadali001@travelhault', 10);
  await prisma.adminUser.create({
    data: {
      username: 'admin@travelhault',
      passwordHash,
    },
  });
    ...
    data: [
      {
        ...
        answer: 'Our packages typically include 4-star / luxury accommodations, private vehicle transfers with dedicated chauffeur, daily breakfast, sightseeing entrance fees, and 24/7 on-trip assistance.',
      ...
      },
      {
        ...
        answer: 'Yes, 100%! All our itineraries are fully tailormade. You can modify hotels, travel duration, sightseeing stops, and special meal or activity preferences to suit your group.',
        category: 'Packages & Customization',
        showOnHomepage: true,
        order: 2,
      },
      {
        ...
        answer: 'Simply click "Enquire Now" on any package or contact us directly. Our travel specialists will draft your customized itinerary and secure your dates upon booking deposit confirmation.',
      ...
      },
      {
        ...
        answer: 'We offer flexible cancellation: 90% refund for cancellations 30+ days before travel, 50% refund 15-29 days prior, and full rescheduling options in case of emergency travel disruptions.',
      ...
      },
      {
        ...
        answer: 'Yes! We provide end-to-end visa application support, appointment scheduling, document verification, and cover letter assistance for all international destinations.',
        category: 'Visa & Travel Info',
        showOnHomepage: true,
        order: 5,
      },
      {
        question: 'What payment methods do you accept?',
        answer: 'We accept Credit/Debit Cards, Net Banking, UPI, Bank Wire Transfers, and international online payments with instant automated receipt generation.',
        category: 'Booking & Payments',
        showOnHomepage: true,
        order: 6,
      },
      {
        question: 'Are flight tickets included in the initial tour package price?',
        answer: 'Flights can be added to any package upon request. We provide competitive airfare quotes tailored to your origin airport and preferred flight timings.',
        category: 'Booking & Payments',
        showOnHomepage: false,
        order: 7,
      },
      {
        question: 'What happens if there are weather delays or flight cancellations during our trip?',
        answer: 'Our 24/7 travel concierge team continuously monitors your trip status and immediately re-arranges transport or hotel stays if weather or flight delays occur.',
        category: 'Visa & Travel Info',
        showOnHomepage: false,
        order: 8,
      },
